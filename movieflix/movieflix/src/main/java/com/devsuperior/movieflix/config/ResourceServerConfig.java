...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.DELETE, MEMBER).hasAnyRole("ADMIN", "MEMBER")
		.antMatchers(HttpMethod.DELETE, ADMIN).hasAnyRole("ADMIN", "MEMBER")
		.antMatchers(HttpMethod.PUT, ADMIN).hasAnyRole("ADMIN", "MEMBER")
